...
All dependencies are specified in the [requirements.txt](https://github.com/benkoger/bear-hunting/requirements.txt) file except for torch which should be installed to match your specific machine (i.e. operating system, CPU or GPU etc.) following the instructions here: https://pytorch.org/get-started/locally/ This repo has been tested with torch==2.3.1+cu121
